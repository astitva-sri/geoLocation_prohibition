...
const String PHONE = "+917619958441";
//--------------------------------------------------------------
...
//GPS Module TX pin to Arduino 12
...
//--------------------------------------------------------------
float initialLatitude = 26.9289779376603;
float initialLongitude = 80.93838258728356;
...
void sendAlert()
{
  //return;
  String sms_data;
  sms_data = "ALERT! Device is outside the predefined area.\r";
